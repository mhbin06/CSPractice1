...
{ 
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // 이스케이프 문자
            Console.WriteLine("미\n\\림\t마\"고");
            // 문자열 연결 연산자(Concatentation Operator)
            Console.WriteLine("Hello" + " " + "World");
            // 문자열 인덱스 접근 [ ]
            ...
            //주의 
            Console.WriteLine('가' + '힣');   // 문자열 연결연산자 x 덧셈 연산자로 인식
            ...
            Console.WriteLine(Math.Ceiling(52.273));    // 53. 올림
            Console.WriteLine(Math.Floor(52.273));      // 52. 내림
            ...
            // #4 21-5 클래스 변수
            Console.WriteLine(Product.TAX_PATIO);
            //Console.WriteLine(p1.TAX_PATIO);  // Java는 가능하나 C#에서는 X
